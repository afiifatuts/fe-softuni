             ...
             <div>
              <div class="row corpItems justify-content-md-start py-5">
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">UI Beginner</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">UX Design</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">UI Design Advanced</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">UX Design Advanced</h3>
                      <p>
           ...
           <div>
              <div class="row corpItems justify-content-md-start py-5">
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Premiere Pro</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">After Effects</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Premiere Pro Advanced</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">After Effects Advanced</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Concept Art</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Concept Art Character</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Concept Art Environment Design</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Character Sculpting ZBrush</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">3D Animation</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">3D Animation Advanced</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Video Production</h3>
                      <p>
             ...
             <div>
              <div class="row corpItems justify-content-md-start py-5">
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Concept Art - Environmen</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Game Modelling Maya</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Game Modelling Maya Advanced</h3>
                      <p>
             ...
             <div>
              <div class="row corpItems justify-content-md-start py-5">
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">Creating Landing Page</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">InDesign</h3>
                      <p>
                ...
                <div class="col-12  col-lg-4 col-md-6">
                  <div class="corpItem">
                    <div>
                      <h3 class="text-center">InDesign Advanced</h3>
                      <p>
