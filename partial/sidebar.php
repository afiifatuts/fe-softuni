   ...
   <!-- ======= Sidebar ======= -->
    <aside id="sidebar" class="sidebar">
      ...
      <li class="nav-heading">Main</li>
        ...
        <i class="fas fa-suitcase"></i><span>Karir</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <li>
          ...
          <li>
            <a href="karir-report.php">
              <i class="bi bi-circle"></i><span>Karir Report</span>
            </a>
          </li>
         
        </ul>
      </li> <!-- End Karir Report Page Nav -->
